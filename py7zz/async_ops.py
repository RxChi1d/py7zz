...
class ProgressInfo:
    ...
    def __repr__(self) -> str:
        return (f"ProgressInfo(operation='{self.operation}', "
...
class AsyncSevenZipFile:
    ...
    async def add_async(self, 
                       name: Union[str, Path],
                       progress_callback: Optional[Callable[[ProgressInfo], None]] = None) -> None:
        """
